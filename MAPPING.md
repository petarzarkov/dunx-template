...
One row is still open:
[dunx#140](https://github.com/petarzarkov/dunx/issues/140), for gating the
explorer the way the dashboard can be gated. `DocsSessionMiddleware` is the
workaround, and the part of it that will rot is the list of paths it restates.

[dunx#137](https://github.com/petarzarkov/dunx/issues/137) was the other, and it
closed in 3.8.2 - which is the note above happening again inside one week.
