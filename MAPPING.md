...
| NestJS                                                          | dunx                                                                                                                                                                                                                                                                                                                                   |
| --------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `CacheModule` + `keyv` + `KeyvIoredisAdapter` + `cache-manager` | `@dunx/infra/cache`: an in-process L1 in front of Redis, with metrics. The one thing it does not ship is degradation - `Cache.wrap` lets a store failure through - so `DegradingCacheStore` sits at the store seam and turns an unreachable backend into a miss. Raised as [dunx#147](https://github.com/petarzarkov/dunx/issues/147). |
